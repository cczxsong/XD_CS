...
public interface EnglishChineseSoap {
     ...
     * @param wordKey
     * @return
     *     returns wsTransproxy.TranslatorResponse.TranslatorResult
     */
    ...
    @RequestWrapper(localName = "Translator", targetNamespace = "http://WebXml.com.cn/", className = "wsTransproxy.Translator")
    @ResponseWrapper(localName = "TranslatorResponse", targetNamespace = "http://WebXml.com.cn/", className = "wsTransproxy.TranslatorResponse")
    public wsTransproxy.TranslatorResponse.TranslatorResult translator(
     ...
     * @param wordKey
     * @return
     *     returns wsTransproxy.ArrayOfString
     */
    ...
    @RequestWrapper(localName = "TranslatorString", targetNamespace = "http://WebXml.com.cn/", className = "wsTransproxy.TranslatorString")
    @ResponseWrapper(localName = "TranslatorStringResponse", targetNamespace = "http://WebXml.com.cn/", className = "wsTransproxy.TranslatorStringResponse")
    ...
    @RequestWrapper(localName = "TranslatorReferString", targetNamespace = "http://WebXml.com.cn/", className = "wsTransproxy.TranslatorReferString")
    @ResponseWrapper(localName = "TranslatorReferStringResponse", targetNamespace = "http://WebXml.com.cn/", className = "wsTransproxy.TranslatorReferStringResponse")
    ...
    @RequestWrapper(localName = "TranslatorSentenceString", targetNamespace = "http://WebXml.com.cn/", className = "wsTransproxy.TranslatorSentenceString")
    @ResponseWrapper(localName = "TranslatorSentenceStringResponse", targetNamespace = "http://WebXml.com.cn/", className = "wsTransproxy.TranslatorSentenceStringResponse")
    ...
    @RequestWrapper(localName = "SuggestWord", targetNamespace = "http://WebXml.com.cn/", className = "wsTransproxy.SuggestWord")
    @ResponseWrapper(localName = "SuggestWordResponse", targetNamespace = "http://WebXml.com.cn/", className = "wsTransproxy.SuggestWordResponse")
    ...
    @RequestWrapper(localName = "GetMp3", targetNamespace = "http://WebXml.com.cn/", className = "wsTransproxy.GetMp3")
    @ResponseWrapper(localName = "GetMp3Response", targetNamespace = "http://WebXml.com.cn/", className = "wsTransproxy.GetMp3Response")
    public byte[] getMp3(
